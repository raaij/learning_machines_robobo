...
class HardwareRobobo(Robobo):
    ...
    def connect(self, address, port=11311):
        ...
        if self._enable_camera:
            self._image_subscribe_front = rospy.Subscriber(
                HardwareRobobo.IMAGE_TOPIC,
                CompressedImage,
                self._camera_callback_front,
                queue_size=1,
            )
    ...
    def set_phone_pan(self, pan_position, pan_speed, pan_blockid=1):
        ...
        self._set_env()
        self._pan_tilt_srv(
            Int16(pan_position), Int8(pan_speed), Int16(pan_blockid), Int16(0), Int8(0), Int16(0)
        )
    ...
    def set_phone_tilt(self, tilt_position, tilt_speed, tilt_blockid=1):
        ...
        self._set_env()
        self._pan_tilt_srv(
            Int16(0), Int8(0), Int16(0), Int16(tilt_position), Int8(tilt_speed), Int16(tilt_blockid)
        )
